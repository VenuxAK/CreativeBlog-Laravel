	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light px-0">
			<a class="navbar-brand order-1 py-0" href="/">
				<img loading="prelaod" decoding="async" class="w-50" src="/logo.png" alt="Reporter Hugo">
			</a>
			...
			<div class="collapse navbar-collapse text-center order-lg-2 order-4" id="navigation">
				<ul class="navbar-nav mx-auto mt-3 mt-lg-0">
					...
					<li class="nav-item"> <a class="nav-link" href="contact.html">Login</a>
					</li>
					<li class="nav-item"> <a class="nav-link" href="contact.html">Register</a>
					</li>
